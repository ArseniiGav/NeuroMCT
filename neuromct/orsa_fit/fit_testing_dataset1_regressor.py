...
def load_simulation(n, bins, path = "/mnt/arsenii/NeuroMCT/kB_fC_LY_10k_events/<el>/testing_data/reco/reco-<n>.root"):
...
def run_fit(n_sim):
    ...
    conditions_default = get_conditions(n_sim)
    ...
    orsa.utils.to_file(result_mcmc, f"/storage/fit_results/testing_data/full_results/full_results_{n_sim}.pkl")
    ...
    orsa.utils.to_file(results, f"/storage/fit_results/testing_data/results/results_{n_sim}.pkl")
