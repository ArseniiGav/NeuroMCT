...
kB = np.arange(*data_configs['kB_training_grid_lims'], dtype=np.float32)
fC = np.arange(*data_configs['fC_training_grid_lims'], dtype=np.float32)
LY = np.arange(*data_configs['LY_training_grid_lims'], dtype=np.float32)
